...
export default function ChatPage() {
  ...
  const init = useCallback(async () => {
    ...
    else setError('No chat channel available.')
    setLoading(false)
  }, [])
  ...
  const sendBtnStyle: React.CSSProperties = { width: 38, height: 38, borderRadius: '50%', border: 'none', background: C.accent, color: '#fff', fontSize: '1.1rem', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }
              ...
              <div style={{ display: 'flex', justifyContent: isYou ? 'flex-end' : 'flex-start', marginTop: isGrouped ? 1 : 8 }}>
                <div style={{ maxWidth: '80%', minWidth: 60 }}>
                  ...
                  <div style={{
                    ...
                    color: C.text, fontSize: '0.85rem', lineHeight: 1.45,
